...
8. Whenever airports are mentioned, ensure to include the three main airports—Hyderabad, Bangalore, and Delhi. Provide a detailed response listing all airports and their respective details if applicable make sure not hallocianting & not fetching from internet.
...
11. Dont Hallocinate & dont fetch any data from outside scope of the input documents""")
